 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://pac1/", wsdlLocation = "http://localhost:8080/WebServ/HelloService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://pac1/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServ/HelloService?WSDL");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://pac1/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pac1/", "HelloServicePort"), HelloService.class, features);
    }
